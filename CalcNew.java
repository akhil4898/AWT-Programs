...
class CalcNew extends WindowAdapter implements ActionListener {
    Frame f;
    Panel p;
    GridLayout g;
    Button b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b_add, b_sub, b_div, b_mul, b_eq, b_mod, b_del, b_cls, b_dot;
    TextField screen, t2;
    int i = 0;
    String ar[];
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         * 
         * String sdf=screen.getText(); sdf=sdf.substring(-1,(sdf.length()-2));
         * screen.setText(sdf+"."); }
         */
